...
import static be.heydari.lib.expressions.ComparisonOperator.from;
...
public class AstWalker {
    ...
    private static Disjunction processDisjunctions(List<Rule> rules) {
    ...
    private static Conjunction processConjunction(Rule rule) {
    ...
    private static BoolPredicate processBoolPredicate(Expression expression) {
            ...
            for (Term term : terms) {
                switch (term.getType()) {
                    ...
                    case BOOLEAN:
                        ...
                        break;
                    default:
                        logger.warning(format("Type not supported: %s", term.getType()));
                        break;
                }
            }
    ...
    private static void processRef(BoolPredicate boolPredicate, RefExpression left, Term term) {
